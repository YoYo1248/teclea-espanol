...
当前运行目录包含 **2152 张卡、2152 个不重复输入目标、203 个内部短轮次单元**。前十七批生产扩库已新增 **1404 张**带 lemma、词性、词频排名和双语短例句的 A1–B2 卡片，但整个目录仍不能称为 A1–C2 完整词库。后续扩库继续使用同一字段和质量闸门。
...
| --- | --- | --- | --- | --- | --- | --- |
| A1 | 422 | 345 | 44 | 33 | 19.6% | 38.9% |
| A2 | 464 | 433 | 24 | 7 | 21.6% | 90.9% |
| B1 | 558 | 520 | 10 | 28 | 25.9% | 82.1% |
| B2 | 508 | 481 | 10 | 17 | 23.6% | 80.3% |
| C1 | 100 | 80 | 10 | 10 | 4.6% | 0% |
| C2 | 100 | 80 | 10 | 10 | 4.6% | 0% |

A1–B2 已形成首个广覆盖目录，其中 A2 为 464 项、B1 为 558 项、B2 为 508 项。C1–C2 的 200 项仍明确标记为候选内容。各等级数字只描述当前教学编组，不能解读为官方 CEFR 完整度或考试词表覆盖率。

## 六个宽分类已覆盖浏览结构，但不能替代 PCIC 逐项映射

| 宽分类 | 所含细场景 | 卡片 | 已出现等级 | 目录占比 |
| --- | --- | --- | --- | --- |
| 核心表达 | 基础、日常、时间 | 526 | A1、A2、B1、B2、C1、C2 | 24.4% |
| 吃住购物 | 餐厅、购物、住宿 | 96 | A1、A2、B1 | 4.5% |
| 出行城市 | 城市、旅行 | 137 | A1、A2、B1、B2、C2 | 6.4% |
| 家庭身心 | 家庭、健康、情绪 | 233 | A1、A2、B1、B2、C1、C2 | 10.8% |
| 学习工作 | 学习、工作 | 530 | A1、A2、B1、B2、C1、C2 | 24.6% |
| 社会世界 | 社会、科技、环境、行政 | 630 | A2、B1、B2、C1、C2 | 29.3% |
...
- 来源四要素（名称、URL、许可、核对日期）：2152/2152。
- 中西例句成对记录：1452/2152。
- 结构化 lemma 与词性：1404/2152（目前来自前十七批生产扩库）。
- 明确 PCIC 等级清单参考：1404/2152（是批次级编辑映射，不是逐条官方认证）。
- 带姓名和日期的专业复核记录：0/2152。
