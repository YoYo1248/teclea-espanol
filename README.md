...
- 关闭浏览器自动纠错与自动大写
- 错误后整词重输，正确后展示中文含义
- 跟打只用于熟悉词形；看义拼写和听音拼写分别整组 0 错且未看提示，单元才标记为掌握
- 旧版本已经完成的单元会保留完成状态，新练习使用双通道掌握标准
- 浏览器原生西班牙语发音（Speech Synthesis）
- 548 张不重复的 A1–B2 练习卡：375 张单词、88 张短语、85 张常用动词原形
- 练习目标只保留单词和不超过 3 个词的短语；较长句子不再作为逐字输入目标
- 首页以 A1–B2 等级和“词汇与短语 / 常用动词专项”为主线；生活主题和小组降级为可选入口
- 主线内保留 5–12 张的小组用于保存和间隔，一组掌握后只续刷同等级、同主线的下一组
